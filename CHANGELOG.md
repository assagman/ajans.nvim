...
* **nes:** set `nes.diff.show = "cursor"` to only show nes diffs at the cursor. Closes [#266](https://github.com/assagman/ajans.nvim/issues/266) ([b1568d3](https://github.com/assagman/ajans.nvim/commit/b1568d37ca0842eb772c86b3e9f214d075bfbf8d))
...
* **nes:** correct inline diff artifact when appending to end of line ([#250](https://github.com/assagman/ajans.nvim/issues/250)) ([f95ba54](https://github.com/assagman/ajans.nvim/commit/f95ba541970c41a631d480062afedb0ebc455e19))
* **nes:** never process cancelled (or out of order) requests ([f8eac10](https://github.com/assagman/ajans.nvim/commit/f8eac1017ee6a13b9b9a827ca7708b52c00c1e72))
...
* **nes.edit:** add buffer validation before accessing position ([#147](https://github.com/assagman/ajans.nvim/issues/147)) ([2cb7359](https://github.com/assagman/ajans.nvim/commit/2cb7359b0908f52dd07ee8200f904ccf975f7679))
* **nes:** ModeChanged: *:n -&gt; i:n, so only when leaving insert to normal mode. Closes [#151](https://github.com/assagman/ajans.nvim/issues/151) ([9e29145](https://github.com/assagman/ajans.nvim/commit/9e29145965b138d65f3d071663b1313f881d3d39))
...
* **status:** show correct signin command when lsp is from `copilot.lua` ([09ebeb4](https://github.com/assagman/ajans.nvim/commit/09ebeb40d964a64b78743c1a051c557a038e7c17))
...
* **copilot:** allow configuring minimum level for copilot LSP messages ([4b6750b](https://github.com/assagman/ajans.nvim/commit/4b6750bb5218c0d8be2f006e41894a1655b1dd27))
...
* **nes:** added triggerKind. Maybe that's needed for nes? ([e535808](https://github.com/assagman/ajans.nvim/commit/e5358082b1c58608d3ed1260f7c4f9841b632ae6))
* **nes:** better didFocus tracking ([3669eae](https://github.com/assagman/ajans.nvim/commit/3669eae4354f9fdd479ff285877f610bb95dfdd5))
* **nes:** don't clear NES on `TextChanged` or `BufWritePre`. Closes [#91](https://github.com/assagman/ajans.nvim/issues/91) ([32fa55c](https://github.com/assagman/ajans.nvim/commit/32fa55c1ad2d391b577f3c667364284937b5cb0c))
* **nes:** don't process unloaded buffers. Closes [#86](https://github.com/assagman/ajans.nvim/issues/86) ([620adf0](https://github.com/assagman/ajans.nvim/commit/620adf034a21e08ac569523cc478caf375eaa24c))
* **nes:** exec nes commands AFTER edits have been applied ([80d1604](https://github.com/assagman/ajans.nvim/commit/80d1604f7081cb6f72f6985af133dced8db5c5a8))
* **nes:** skip old edits early ([8395007](https://github.com/assagman/ajans.nvim/commit/839500723b578984ed6e4975b3302c8267784e81))
* **nes:** textDocument/didFocus ([b7085d7](https://github.com/assagman/ajans.nvim/commit/b7085d79df9efb9f8be5ca4a65d771b163d7d34c))
* **nes:** trigger on `ModeChanged *:n` instead of `InsertLeave`. See [#125](https://github.com/assagman/ajans.nvim/issues/125) ([abbd051](https://github.com/assagman/ajans.nvim/commit/abbd05132d88e2966016e40d2184bcc930ccbc48))
...
* **status:** always return `nil` when copilot status is disabled in config ([f908fec](https://github.com/assagman/ajans.nvim/commit/f908fec933fe3e5ad3c31fb3ed7fb48fee232a44))
...
* **nes:** only send didFocus events for regular buffers and if different ([39a1638](https://github.com/assagman/ajans.nvim/commit/39a16381ef711a4e6ac6f95f4ba1297365889fef))
...
* **copilot-cli:** exclude copilot-language-server procs. Closes [#75](https://github.com/assagman/ajans.nvim/issues/75) ([ce85284](https://github.com/assagman/ajans.nvim/commit/ce852849344f3ef0410d2b3f6e5465819603e41f))
...
* **health:** added extra checks for duplicate Copilot LSP servers ([0b89f04](https://github.com/assagman/ajans.nvim/commit/0b89f04999065e8917eb480c9243a70e7ccdf147))
* **nes:** added enable/disable/toggle for NES ([2d280e9](https://github.com/assagman/ajans.nvim/commit/2d280e931e02a44cb65c35d58ae42f55538866bc))
* **nes:** disable nes fully when `enabled=false` ([11428c1](https://github.com/assagman/ajans.nvim/commit/11428c1e9890056136329dd4c0451dcb81feb830))
* **nes:** trigger AjansNesShow and AjansNesHide after update. Closes [#19](https://github.com/assagman/ajans.nvim/issues/19) ([302cec7](https://github.com/assagman/ajans.nvim/commit/302cec770ca0a4b7dfafd7879034d33320592b33))
...
* **health:** special checks for LSP server bundled with copilot.lua and copilot.vim. Fixes [#15](https://github.com/assagman/ajans.nvim/issues/15) ([d11ee7f](https://github.com/assagman/ajans.nvim/commit/d11ee7f7209d3417d1bc007f387b665db43117bc))
...
* **nes:** allow any lsp server name containing `copilot` ([#9](https://github.com/assagman/ajans.nvim/issues/9)) ([74acbde](https://github.com/assagman/ajans.nvim/commit/74acbde14b824f67ba0194992bb669a053033711))
* **nes:** delete at end of file triggered error ([7b8769f](https://github.com/assagman/ajans.nvim/commit/7b8769f7f6c820b66965b91382fcf34d3da5889f))
...
* **config:** `enabled` option that defaults to checking `vim.g|b.copilot.nes == false` ([9ab4458](https://github.com/assagman/ajans.nvim/commit/9ab44589492ae06639d1af2bf5be674a95e70460))
...
* **diff:** added support for Neovim &lt; 0.12 ([9166a6b](https://github.com/assagman/ajans.nvim/commit/9166a6b8bc2e3316cf404b76864d9cba84abb588))
* **diff:** better diff rendering to let extmarks behave ([90f693b](https://github.com/assagman/ajans.nvim/commit/90f693b161d0c0ba3aaa0d218661feb6a9f1e0c8))
* **diff:** fixed some edge cases for insertions before after first/last line of the buffer ([a3ec994](https://github.com/assagman/ajans.nvim/commit/a3ec994d53ed5d19321f198ad9604ce17bf97ae7))
* **diff:** hunk position for inline diff was sometimes wrong. Fixes [#4](https://github.com/assagman/ajans.nvim/issues/4) ([f421518](https://github.com/assagman/ajans.nvim/commit/f421518ebe9b0184d020d7694f2ffbcf40719aa3))
* **diff:** line insert before first line ([2cc5374](https://github.com/assagman/ajans.nvim/commit/2cc53741c5ec2eb8bd031495a45b635736edaabf))
* **nes:** only execute edit command when available ([49e79a6](https://github.com/assagman/ajans.nvim/commit/49e79a6d7a36e8d03ae790efe2c4b7a2c9b61376))
* **nes:** properly clear render flag and make it different from the disable flag ([3271eea](https://github.com/assagman/ajans.nvim/commit/3271eea2630e4342fa719e0b10ea75c7f99cdb55))
...
* added trigger/clear configs ([55beb96](https://github.com/assagman/ajans.nvim/commit/55beb9626bcbe7277d8aee15aca075e6befad138))
* **config:** configure copilot through Lsp events. Not needed to use `vim.lsp.config` for this ([3fe1f3d](https://github.com/assagman/ajans.nvim/commit/3fe1f3da260f870cd0e93b5ecc02a4140cdedc4d))
* **diff:** better inline diffing ([23ca2c6](https://github.com/assagman/ajans.nvim/commit/23ca2c6b89ccad93ed3a1aa9c1f559fcc8ed0df2))
* **diff:** diff config options ([ac5f9b8](https://github.com/assagman/ajans.nvim/commit/ac5f9b844fc998360fba7b8458517c8db8ca06aa))
* **diff:** diff options ([d606531](https://github.com/assagman/ajans.nvim/commit/d606531f617f1346551e1f840c6af03300d5cfb9))
* **diff:** diff refactoring ([ef2884e](https://github.com/assagman/ajans.nvim/commit/ef2884e513f45cca69e99fb3d39cca54e4bc8cae))
...
* **nes:** jump to end of text edit after apply ([77ab4b2](https://github.com/assagman/ajans.nvim/commit/77ab4b2815bb65e462155ba11c79e62477a1feee))
...
* **ui:** optional signs ([59abe52](https://github.com/assagman/ajans.nvim/commit/59abe526852fd3e56532452dfa49793b4d5e1b8b))
...
* **config:** move result_type to diff ([489834c](https://github.com/assagman/ajans.nvim/commit/489834c0a7d58110b008043f2215369a66a90328))
* **diff:** diff fixes ([c816758](https://github.com/assagman/ajans.nvim/commit/c816758ae0f5698fc682c372313daa1cbefd2a2f))
* offset encoding ([11b38ae](https://github.com/assagman/ajans.nvim/commit/11b38ae68f0557c15e082d93c43e8eca40686fac))
* **status:** notify on copilot errors/warnings ([765c8e3](https://github.com/assagman/ajans.nvim/commit/765c8e3afe6b9c171403666171f03d983274df74))
* **ui:** one sign per hunk ([5a16ea8](https://github.com/assagman/ajans.nvim/commit/5a16ea84e983a4d5c6edaaa1a6662db2d138bf82))
