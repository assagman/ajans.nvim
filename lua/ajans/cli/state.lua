...
---@class ajans.cli.State
---@field tool ajans.cli.Tool
---@field attached? boolean
---@field external? boolean
---@field installed? boolean
---@field session? ajans.cli.Session
---@field started? boolean
---@field terminal? ajans.cli.Terminal

---@class ajans.cli.Filter
---@field attached? boolean
---@field cwd? boolean
---@field external? boolean
---@field installed? boolean
...
---@param t ajans.cli.State
---@param filter? ajans.cli.Filter
...
---@param filter? ajans.cli.Filter
---@return ajans.cli.State[]
function M.get(filter)
  filter = filter or {}
  local all = {} ---@type ajans.cli.State[]
...
---@param cb fun(state: ajans.cli.State, attached?: boolean):any?
---@param opts? ajans.cli.With
function M.with(cb, opts)
  ...
  if #attached == 0 and opts.attach then
    require("ajans.cli.ui.select").select({
      auto = true,
      filter = opts.filter,
      cb = use,
    })
