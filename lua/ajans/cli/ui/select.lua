...
---@class ajans.cli.Select: ajans.cli.With
---@field cb fun(state?:ajans.cli.State)
...
---@param state ajans.cli.State|snacks.picker.Item
...
function M.format(state, picker)
  ...
  local status_hl = "AjansCli" .. status:gsub("^%l", string.upper)
