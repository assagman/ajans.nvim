...
---@alias ajans.Pos {[1]:integer, [2]:integer}

---@class ajans.lsp.NesEdit
---@field command lsp.Command
---@field range lsp.Range
---@field text string
---@field textDocument {uri: string, version: integer}

---@class ajans.NesEdit: ajans.lsp.NesEdit
---@field buf integer
---@field from ajans.Pos
---@field to ajans.Pos
---@field _diff ajans.Diff
local M = {}
M.__index = M
...
---@param client vim.lsp.Client
---@param edit ajans.lsp.NesEdit
function M.new(client, edit)
  local self = setmetatable(edit, M) --[[@as ajans.NesEdit]]
...
function M:diff()
  if not self._diff then
    self._diff = require("ajans.nes.diff").diff(self)
  end
  return self._diff
end
